...
/**
 * Columndel is a column for the [[GridView]] widget that displays buttons for viewing and manipulating the items.
 *
 * To add an Columndel to the gridview, add it to the [[GridView::columns|columns]] configuration as follows:
 *
 * ```php
 * 'columns' => [
 *     // ...
 *     [
 *         'class' => Columndel::className(),
 *         // you may configure additional properties here
 *     ],
 * ]
 * ```
 *
 * For more details and usage information on Columndel, see the [guide article on data widgets](guide:output-data-widgets).
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @since 2.0
 */
class Columndel extends Column
{
    /**
     * {@inheritdoc}
     */
     ...
     *
     * As an example, to only have the view, and update button you can add the Columndel to your GridView columns as follows:
     *
     * ```php
     * ['class' => 'yii\grid\Columndel', 'template' => '{view} {update}'],
     * ```
     *
     * @see buttons
     */
     ...
     *
     * ```php
     * function (string $action, mixed $model, mixed $key, integer $index, Columndel $this) {
     *     //return string;
     * }
     * ```
     *
