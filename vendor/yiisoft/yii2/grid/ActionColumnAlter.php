...
/**
 * ActionColumnAlter is a column for the [[GridView]] widget that displays buttons for viewing and manipulating the items.
 *
 * To add an ActionColumnAlter to the gridview, add it to the [[GridView::columns|columns]] configuration as follows:
 *
 * ```php
 * 'columns' => [
 *     // ...
 *     [
 *         'class' => ActionColumnAlter::className(),
 *         // you may configure additional properties here
 *     ],
 * ]
 * ```
 *
 * For more details and usage information on ActionColumnAlter, see the [guide article on data widgets](guide:output-data-widgets).
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @since 2.0
 */
class ActionColumnAlter extends Column
{
    /**
     * {@inheritdoc}
     */
     ...
     *
     * As an example, to only have the view, and update button you can add the ActionColumnAlter to your GridView columns as follows:
     *
     * ```php
     * ['class' => 'yii\grid\ActionColumnAlter', 'template' => '{view} {update}'],
     * ```
     *
     * @see buttons
     */
     ...
     *
     * ```php
     * function (string $action, mixed $model, mixed $key, integer $index, ActionColumnAlter $this) {
     *     //return string;
     * }
     * ```
     *
