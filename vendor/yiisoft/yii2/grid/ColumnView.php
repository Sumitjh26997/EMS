...
/**
 * ColumnView is a column for the [[GridView]] widget that displays buttons for viewing and manipulating the items.
 *
 * To add an ColumnView to the gridview, add it to the [[GridView::columns|columns]] configuration as follows:
 *
 * ```php
 * 'columns' => [
 *     // ...
 *     [
 *         'class' => ColumnView::className(),
 *         // you may configure additional properties here
 *     ],
 * ]
 * ```
 *
 * For more details and usage information on ColumnView, see the [guide article on data widgets](guide:output-data-widgets).
 *
...
class ColumnView extends Column
{
     ...
     *
     * As an example, to only have the view, and update button you can add the ColumnView to your GridView columns as follows:
     *
     * ```php
     * ['class' => 'yii\grid\ColumnView', 'template' => '{view} {update}'],
     * ```
     *
     * @see buttons
     */
     ...
     *
     * ```php
     * function (string $action, mixed $model, mixed $key, integer $index, ColumnView $this) {
     *     //return string;
     * }
     * ```
     *
